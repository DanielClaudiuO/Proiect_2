...
public class Program {
    ...
    public static void main(String[] args){
        IObserver client1=new Observer("Daniel");
        IObserver client2=new Observer("Oanta");
        IObserver client3=new Observer("Filip");
        IObserver client4=new Observer("Nicu");
       List<IObserver> clientList= new ArrayList<>();
       clientList.add(client1);
        clientList.add(client2);
        clientList.add(client3);
        clientList.add(client4);
        var stockMarket=new GroupChat(clientList,clientList);
